...
const file_auction_proto_rawDesc = "" +
	...
	"\x02ok\x18\x01 \x01(\bR\x02ok2\xc6\x02\n" +
	...
	"\vUpdateState\x12\".AuctionService.UpdateStateRequest\x1a#.AuctionService.UpdateStateResponse\x12P\n" +
	"\tHeartbeat\x12 .AuctionService.HeartbeatRequest\x1a!.AuctionService.HeartbeatResponseB)Z'github.com/3SemClon/AuctionService/grpcb\x06proto3"
...
var file_auction_proto_goTypes = []any{
	...
	(*HeartbeatRequest)(nil),    // 6: AuctionService.HeartbeatRequest
	(*HeartbeatResponse)(nil),   // 7: AuctionService.HeartbeatResponse
}
var file_auction_proto_depIdxs = []int32{
	...
	6, // 3: AuctionService.AuctionService.Heartbeat:input_type -> AuctionService.HeartbeatRequest
	1, // 4: AuctionService.AuctionService.Bid:output_type -> AuctionService.BidResponse
	3, // 5: AuctionService.AuctionService.GetResult:output_type -> AuctionService.ResultResponse
	5, // 6: AuctionService.AuctionService.UpdateState:output_type -> AuctionService.UpdateStateResponse
	7, // 7: AuctionService.AuctionService.Heartbeat:output_type -> AuctionService.HeartbeatResponse
